    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh]'>
      ...
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3'>
          <input onChange={onChangeHandler} name='fristName' value={formData.fristName} className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type='text' placeholder='Frist Name' required/>
        ...
        <div className='flex gap-3'>
         ...
         <div className='flex gap-3'>
          <input onChange={onChangeHandler} name='zipcode' value={formData.zipcode}  className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type='number' placeholder='Zip' required/>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={()=>setMethod('cod') } className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              ...
              <p className='text-f=gray-500 text-sm font-medium mx-4'>CASH ON DELIVERY</p>
            </div>
